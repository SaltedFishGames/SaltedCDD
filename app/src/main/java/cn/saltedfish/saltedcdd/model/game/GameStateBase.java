...
public abstract class GameStateBase {
    ...
    public abstract ShowCardResult onPlayerShowCard(CDDGameBoard board, CDDPlayer player, CardGroup card);

    public abstract ShowCardResult tryPlayerShowCard(CDDGameBoard board, CDDPlayer player, CardGroup card);
